...
% if cfg1.blackrock
if nargin ==1
    if strcmp(cfg.headerfile(end-3:end),'.nev');
        nvdat = openNEV(cfg.headerfile);
        hdr.Fs = double(nvdat.MetaTags.SampleRes);
    else
...
cfg.version.id = '$Id: ft_rejectartifact.m 314 2009-12-17 13:23:36Z ingnie $';
