%% MAKES SETS # 200-299,  offset .45 and .15,  60 total blocks
...
for l = 1:732 %change last number to change # of screens produced
    ...
    for poslop=1:size(pos,1)-1
        ...
        Larrx=[r (r+.6) (r+.45) (r+.45) ; (r+.6) (r+.6) r (r+.6); r (r+.6) r r; r (r+.6) r r];
        Larry=[p p p (p-.6); (p-.6) p (p-.45) (p-.45); (p-.45) (p-.45) p (p-.6); (p-.15) (p-.15) p (p-.6)];
