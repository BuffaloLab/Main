...
#---  Make collision spheres for rays around bananas smaller
#
#============================================================================================================
...
#
#5.1 = A given number of bananas appear on the field and you have to go gather them all,
#      then a new set appear.
