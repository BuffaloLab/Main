...
if strcmpi(Flags.ReadData, 'read')
    ...
    if ~isempty(allExtraDataPacketIndices) % if there is any extra packets
        ...
        if ~isempty(commentIndices)
            ...
            NEV.Data.Comments.TimeStampSec = double(NEV.Data.Comments.TimeStamp)/30000;
...
%             NEV.Data.Tracking.NodeCount     = typecast(NEV.Data.Tracking.NodeCount(:), 'uint16').';
            ...
            NEV.Data.Tracking.MarkerCount    = typecast(NEV.Data.Tracking.PointCount(:), 'uint16').';
            pointCount = max(NEV.Data.Tracking.PointCount);
