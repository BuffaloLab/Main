...
seconds = 5;%can save up to 5 minutes, 300 seconds, with current settings
framesPerSec = 30;
...
if saveWMV
%     video = setdefaults([],'width',formatInfo.width,'height',formatInfo.height);%values must be in pixels and be even integers
    video = formatInfo;
    ...
    mmwrite([fileDir filePrefix '_' num2str(clipSuffix)  '.wmv'],video)
end
